...
try:
    ...
    config_disparo(browser, suffix, phone, whatsapp_send) # NOTE Configura Disparo no WhatsAPP
    

    config_notification(browser, suffix, cpf, notification_send) # NOTE Configura disparo de Notificação
